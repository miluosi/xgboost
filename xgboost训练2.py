...
gsearch1 = GridSearchCV(estimator =XGBR( learning_rate =0.1, n_estimators=140, max_depth=5,
 min_child_weight=1, gamma=0.29, subsample=0.8, colsample_bytree=0.8, objective= 'reg:linear',
...
gsearch1 = GridSearchCV(estimator =XGBR( learning_rate =0.1, n_estimators=140, max_depth=3,
 min_child_weight=2, gamma=0, subsample=0.8, colsample_bytree=0.6, objective= 'reg:linear',
 nthread=4, scale_pos_weight=1, seed=27),
